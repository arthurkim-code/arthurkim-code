...
excel_url = 'C:/Users/kkim/Documents/Python/TEST/skbrickchange.xlsx'
...
df4['Drop_territory1'] = ';' + df4['Territory'] + ';' # 같은 팀일 때는 manager를 삭제할 필요가 없음.
...
#df5.to_excel('C:/Users/kkim/Documents/Python/TEST/team1_' + d1 + '.xlsx', index=False)

df5.to_csv('C:/Users/kkim/Documents/Python/TEST/team1_' + d1 + '.csv', index=False, encoding="utf-8-sig") #파일 8MB 이상시 CSV로 추출
